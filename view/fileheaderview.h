#ifndef FILEHEADERVIEW_H
#define FILEHEADERVIEW_H
...
class FileHeaderView : public QTableView
{
    Q_OBJECT
private:
...
public:
    explicit FileHeaderView(QWidget *parent = nullptr);
    ~FileHeaderView();
    QWidget *parent;
