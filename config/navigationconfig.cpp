...
const NavigationConfig NavigationConfig::ITEM_PAGE_DOS_HEADER("DOS_HEADER", ":/images/images/icon/navigation/m8.ico", PAGE_DOS_HEADER, PAGE_TOP);
const NavigationConfig NavigationConfig::ITEM_PAGE_NT_HEADERS("NT_HEADERS", ":/images/images/icon/navigation/m8.ico", PAGE_NT_HEADERS, PAGE_TOP);
const NavigationConfig NavigationConfig::ITEM_PAGE_FILE_HEADER("FILE_HEADER", ":/images/images/icon/navigation/m8.ico", PAGE_FILE_HEADER, PAGE_NT_HEADERS);
const NavigationConfig NavigationConfig::ITEM_PAGE_OPTIONAL_HEADER("OPTIONAL_HEADER", ":/images/images/icon/navigation/m8.ico", PAGE_OPTIONAL_HEADER, PAGE_NT_HEADERS);
const NavigationConfig NavigationConfig::ITEM_PAGE_DATA_DIRECTORIES("DATA_DIRECTORIES", ":/images/images/icon/navigation/m8.ico", PAGE_DATA_DIRECTORIES, PAGE_OPTIONAL_HEADER);
const NavigationConfig NavigationConfig::ITEM_PAGE_SECTION_HEADERS("SECTION_HEADERS", ":/images/images/icon/navigation/m8.ico", PAGE_SECTION_HEADERS, PAGE_TOP);
const NavigationConfig NavigationConfig::ITEM_PAGE_EXPORT_DIRECTORY("EXPORT_DIRECTORY", ":/images/images/icon/navigation/m8.ico", PAGE_EXPORT_DIRECTORY, PAGE_TOP);
...
const NavigationConfig NavigationConfig::ITEM_PAGE_RESOURCE_DIRECTORY("RESOURCE_DIRECTORY", ":/images/images/icon/navigation/m8.ico", PAGE_RESOURCE_DIRECTORY, PAGE_TOP);
const NavigationConfig NavigationConfig::ITEM_PAGE_EXCEPTION_DIRECTORY("EXCEPTION_DIRECTORY", ":/images/images/icon/navigation/m8.ico", PAGE_EXCEPTION_DIRECTORY, PAGE_TOP);
